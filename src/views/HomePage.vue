...
/* ===== EFEITOS HOVER ===== */
.card-standard li:hover,
.card-with-image li:hover {
...
/* ===== EFEITO DE BRILHO ===== */
.card-standard li::before,
.card-with-image li::before {
    content: '';
    position: absolute;
    top: 0;
    left: -100%;
...
.card-standard li:hover::before,
.card-with-image li:hover::before {
    left: 100%;
}
...
/* ===== EFEITO PULSE NO CARD DE CONTATO ===== */
